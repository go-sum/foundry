...
func ContactPage(req viewstate.Request, submitURL string, data contactpartial.FormData) g.Node {
...
func ContactContent(req viewstate.Request, submitURL string, data contactpartial.FormData) g.Node {
