...
func ContactPage(req viewstate.Request, submitURL string, data partials.ContactFormData) g.Node {
...
func ContactContent(req viewstate.Request, submitURL string, data partials.ContactFormData) g.Node {
	return h.Div(h.Class("max-w-md mx-auto py-16 px-4"),
		...
		partials.ContactForm(req, submitURL, data),
	)
}
