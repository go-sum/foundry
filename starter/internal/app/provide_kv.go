...
// contact rate limiting are wired through KV regardless of which session store
// implementation is selected. In testing, only the explicit kv session store
// path requires bringing up the shared KV dependency.
