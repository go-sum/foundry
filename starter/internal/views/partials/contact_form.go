// Package partials provides HTMX partial components.
package partials
...
// ContactFormData carries view state for the contact form template.
...
func ContactForm(req viewstate.Request, submitURL string, data ContactFormData) g.Node {
...
func formState(req viewstate.Request, submitURL string, data ContactFormData) g.Node {
	return h.Form(
