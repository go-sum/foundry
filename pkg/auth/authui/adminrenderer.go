...
// NewAdminRenderer returns an authn.AdminRenderer that builds views with
// componentry and delegates full-page layout to cfg.Page.
func NewAdminRenderer(cfg Config) authn.AdminRenderer {
	return &adminRenderer{cfg: cfg}
}

// UsersListPage renders the admin user list.
func (r *adminRenderer) UsersListPage(c *web.Context, data authn.UsersListPageData) (web.Response, error) {
...
func (r *adminRenderer) UserEditPage(c *web.Context, data authn.UserEditPageData) (web.Response, error) {
...
func (r *adminRenderer) BootstrapPage(c *web.Context, data authn.BootstrapPageData) (web.Response, error) {
